CREATE DATABASE  IF NOT EXISTS `quizzer` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `quizzer`;
...
CREATE TABLE `permission` (
  ...
  CONSTRAINT `FK_Utilisateur` FOREIGN KEY (`idUtilisateur`) REFERENCES `utilisateur` (`idUtilisateur`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `quiz` (
  ...
  CONSTRAINT `FK_Quiz_Utilisateur` FOREIGN KEY (`idUser`) REFERENCES `utilisateur` (`idUtilisateur`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
